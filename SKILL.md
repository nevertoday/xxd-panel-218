---
name: xxd-panel-218
description: "Create Panel 218 raster artwork: Minimal Needle-Felt Picture-Book Illustration. Use when the user invokes xxd-panel-218 or requests this specific visual language."
---
...
Write final PNGs directly inside one fresh task directory under `~/Desktop/xxd/xxd-panel-218/` or the explicit output root. Use collision-safe filenames; do not create source, mode, or size subdirectories and do not generate an automatic contact sheet.
...
- `references/xxd-panel-218-prompt.zh-CN.md` and `.en.md` — delivery adapter notes
